...
<div class="workingArea">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <c:forEach items="${cs}" var="c">
                <tr>
                    ...
                    <%--编辑的超连接--%>
                    <td><a href="admin_category_edit?cid=${c.id}"><span class="glyphicon glyphicon-edit"></span></a>
                    </td>
    ...
    <div class="panel panel-warning addDiv">
        ...
        <div class="panel-body">
            <form id="addForm" method="post" action="admin_category_add" enctype="multipart/form-data"> <%--上传文件--%>
